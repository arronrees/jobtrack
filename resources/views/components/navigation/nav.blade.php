...
<nav class="flex flex-col mb-4 md:mb-0 md:fixed md:top-4 md:left-4" id="nav">
    <div class="flex gap-3 mb-4 pb-4 border-b border-slate-200">
        ...
        <p class="font-bold text-xl">Job Tracker</p>
        <button type="button" id="close__nav"
            class="ml-auto p-2 rounded hover:bg-slate-200/50 focus:bg-slate-200/50 transition md:hidden">
    ...
    <div id="mobile__nav">
        <ul class="grid gap-1">
            <li>
                <x-navigation.nav-link text="Home" href='/dashboard' :active="request()->is('dashboard')">
            ...
            <li>
                <x-navigation.nav-link href="/jobs" text="Jobs" :active="request()->is('jobs')">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
            ...
            <li>
                <x-navigation.nav-link href="/clients" text="Clients" :active="request()->is('clients')">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
                        <path fill-rule="evenodd"
            ...
            <li>
                <x-navigation.nav-link href="/users" text="Users" :active="request()->is('users')">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
                        <path
