<x-layouts.guest>
    ...
    <div class="flex items-center justify-center flex-col h-screen">
        ...
        <x-card>
            ...
            <form action="/login" method="POST" class="flex flex-col gap-4 sm:min-w-[375px] mb-6">
                @csrf
            ...
            <p class="text-sm">Don't have an account? <a href="/register" class="font-bold">Sign Up</a></p>
